import{c as s,d as l,Z as y,f as h}from"./elements-d59828a4.js";import{G as m}from"./GridLayer-052b3f5c.js";import{C}from"./MainController-ab86abdb.js";import"./_commonjsHelpers-28e086c5.js";const r=700,o=600,a=()=>{const e=s(r),n=l(r,o),t=new m("grid",{order:1,majorColor:"black",minorColor:"black",majorWidth:.5,minorWidth:.5});return t.onMount({elm:n,width:r,height:o}),new y(n,g=>{t.onRescale(g)}).adjustToSize(r,o),e.appendChild(h("Low level interface to create and display grid. This layer is made using canvas.")),e.appendChild(n),e},i=()=>{const e=s(r),n=l(r,o),t=new m("grid",{order:1,majorColor:"black",minorColor:"black",majorWidth:.5,minorWidth:.5});return new C({container:n,layers:[t]}).adjustToSize(r,o),e.appendChild(h("High level interface to create and display grid. This layer is made using canvas.")),e.appendChild(n),e},f={title:"ESV Intersection/Features/Grid",component:a};var d;a.parameters={...a.parameters,storySource:{source:`() => {
...
//# sourceMappingURL=grid-layer.stories-91236f59.js.map
