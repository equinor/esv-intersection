import{c as l,d,f as p}from"./elements-3bfbc1e4.js";import{G as h}from"./GridLayer-a4c9afad.js";import{C as m}from"./MainController-a0113b3f.js";const r=700,a=600,e=()=>{const t=l(r),n=d(r,a),o=new m({container:n});return o.addLayer(new h("grid")),o.adjustToSize(r,a),t.appendChild(p("A basic example of setting up the controller along with a layer. The only required input is an HTML container.")),t.appendChild(n),t},w={title:"ESV Intersection/Other examples",component:e};var i,s,c;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`() => {
  ...
  return root;
}`,...(c=(s=e.parameters)==null?void 0:s.docs)==null?void 0:c.source}}};const C=["BasicSetup"];export{e as BasicSetup,C as __namedExportsOrder,w as default};
