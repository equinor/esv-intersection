import{c as s,b as l,Z as y,e as h}from"./elements.87f68392.js";import{G as m}from"./GridLayer.439d0b2f.js";import{C}from"./MainController.5bd28a66.js";import"./_commonjsHelpers.c10bf6cb.js";const r=700,o=600,a=()=>{const e=s(r),n=l(r,o),t=new m("grid",{order:1,majorColor:"black",minorColor:"black",majorWidth:.5,minorWidth:.5});return t.onMount({elm:n,width:r,height:o}),new y(n,g=>{t.onRescale(g)}).adjustToSize(r,o),e.appendChild(h("Low level interface to create and display grid. This layer is made using canvas.")),e.appendChild(n),e},i=()=>{const e=s(r),n=l(r,o),t=new m("grid",{order:1,majorColor:"black",minorColor:"black",majorWidth:.5,minorWidth:.5});return new C({container:n,layers:[t]}).adjustToSize(r,o),e.appendChild(h("High level interface to create and display grid. This layer is made using canvas.")),e.appendChild(n),e},H={title:"ESV Intersection/Features/Grid",component:a};var d;a.parameters={...a.parameters,storySource:{source:`() => {
...
//# sourceMappingURL=grid-layer.stories.7c1b0418.js.map
