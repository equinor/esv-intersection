import{I as L,C as M}from"./MainController-BrT9vEc5.js";import{c as S,a as D,Z,b as P,d as R}from"./elements-bFXFHGGJ.js";import{t as H,g as b,C as W}from"./picks-B2GOuoQO.js";import{W as x}from"./WellborePathLayer-B27LKqGl.js";import{g as T,a as B,b as z}from"./data-D8Ls4_G-.js";import"./GridLayer-PgiAz4v5.js";import"./preload-helper-Dp1pzeXC.js";import"./_commonjsHelpers-CqkleIqs.js";const I=[0,500],F=[0,500],U=500,V=500,i=500,j=500,s=()=>{const n=S(i),a=D(i,j);return Promise.all([T(),B(),z()]).then(d=>{const[p,m,h]=d,g=H(m,h),o=new L(p.map(e=>[e.easting,e.northing,e.tvd])),u=b(g),l=new x("path",{referenceSystem:o,stroke:"red",strokeWidth:"1"}),r=new W("callout",{order:1,referenceSystem:o});r.onMount({elm:a}),l.onMount({elm:a}),r.onUpdate({data:u});const t=new Z(a,e=>{r.onRescale(e),l.onRescale(e)});t.setBounds(I,F),t.adjustToSize(U,V),t.setViewport(1500,1500,3e3)}),n.appendChild(P("Low level interface for creating and displaying a callout layer. We have also added a wellbore path to show the picks along its path. This layer is made using canvas.")),n.appendChild(a),n.appendChild(R()),n},c=()=>{const n=S(i),a=D(i,j);return Promise.all([T(),B(),z()]).then(d=>{const[p,m,h]=d,g=H(m,h),o=new L(p.map(e=>[e.easting,e.northing,e.tvd])),u=b(g),l=new x("path",{referenceSystem:o,stroke:"red",strokeWidth:"1"}),r=new W("callout",{order:1,data:u,referenceSystem:o}),t=new M({container:a,referenceSystem:o});t.addLayer(l),t.addLayer(r),t.setBounds(I,F),t.adjustToSize(U,V),t.setViewport(1500,1500,3e3)}),n.appendChild(P("High level interface for creating and displaying a callout layer. We have also added a wellbore path to show the picks along its path. This layer is made using canvas.")),n.appendChild(a),n.appendChild(R()),n},N={title:"ESV Intersection/Features/Callout",component:s};var y,w,f;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`() => {
  ...
  root.appendChild(createFPSLabel());
  return root;
}`,...(v=(k=c.parameters)==null?void 0:k.docs)==null?void 0:v.source}}};const Q=["CalloutUsingLowLevelInterface","CalloutUsingHighLevelInterface"];export{c as CalloutUsingHighLevelInterface,s as CalloutUsingLowLevelInterface,Q as __namedExportsOrder,N as default};
