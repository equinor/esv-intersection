import{I as y,C as k}from"./MainController-a0113b3f.js";import{c as f,d as u,e as S,Z as z}from"./elements-3bfbc1e4.js";import{W as g}from"./WellborePathLayer-8a5350d2.js";import{g as W}from"./data-e45bb153.js";import"./GridLayer-a4c9afad.js";const t=700,a=600,r=()=>{const e=f(t),o=u(t,a),c=S();return W().then(i=>{const p={order:1,strokeWidth:"2px",stroke:"black",referenceSystem:new y(i)},s=new g("wellborepath",p);s.onMount({elm:o,width:t,height:a});const n=new z(o,P=>{s.onRescale(P)});n.setBounds([0,1e3],[0,1e3]),n.adjustToSize(t,a),n.setViewport(1e3,1e3,5e3),e.appendChild(o),e.appendChild(c)}),e},l=()=>{const e=f(t),o=u(t,a),c=S();return W().then(i=>{const p={order:1,strokeWidth:"2px",stroke:"black",referenceSystem:new y(i)},s=new g("wellborepath",p),n=new k({container:o,layers:[s]});n.setBounds([0,1e3],[0,1e3]),n.adjustToSize(t,a),n.setViewport(1e3,1e3,5e3),e.appendChild(o),e.appendChild(c)}),e},V={title:"ESV Intersection/Features/Wellborepath",component:r};var h,d,m;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`() => {
  ...
  return root;
}`,...(L=(w=l.parameters)==null?void 0:w.docs)==null?void 0:L.source}}};const j=["WellborepathUsingLowLevelInterface","WellborepathUsingHighLevelInterface"];export{l as WellborepathUsingHighLevelInterface,r as WellborepathUsingLowLevelInterface,j as __namedExportsOrder,V as default};
